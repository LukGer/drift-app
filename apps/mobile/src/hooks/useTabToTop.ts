  ...
  React.useEffect(() => {
    ...
    while (currentNavigation) {
      if (currentNavigation.getState()?.type === "tab") {
        tabNavigations.push(
          currentNavigation as unknown as NavigationProp<ReactNavigation.RootParamList>
        );
      }
    ...
    const unsubscribers = tabNavigations.map((tab) => {
      return tab.addListener(
        ...
        (e: EventArg<"tabPress", true>) => {
          ...
          const isFirst =
            tabNavigations.includes(
              navigation as unknown as NavigationProp<ReactNavigation.RootParamList>
